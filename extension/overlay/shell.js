(() => {
  ...
  const styles = `
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .insta-toolbox-settings-dialog { width: min(440px, calc(100vw - 28px)); max-height: min(720px, calc(100dvh - 28px)); overflow: auto; scrollbar-gutter: stable; font-family: var(--insta-toolbox-font, system-ui, sans-serif); }
    .insta-toolbox-settings-dialog::backdrop { background: rgba(12, 14, 12, .44); backdrop-filter: grayscale(.65) blur(1px); }
    .insta-toolbox-settings-dialog form { gap: 16px; padding: 16px; }
    .insta-toolbox-settings-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; position: sticky; top: -16px; z-index: 1; margin: -16px -16px 0; padding: 8px 16px; border-bottom: 1px solid var(--insta-toolbox-line); background: var(--insta-toolbox-surface-raised); }
    .insta-toolbox-settings-heading .insta-toolbox-icon-button { flex: 0 0 auto; }
    .insta-toolbox-settings-heading h2 { font: 650 20px/24px var(--insta-toolbox-font, system-ui, sans-serif); }
    .insta-toolbox-settings-dialog .insta-toolbox-note { margin: 0; }
    .insta-toolbox-settings-section { min-width: 0; margin: 0; padding: 0; border: 0; }
    .insta-toolbox-settings-section > legend { margin-bottom: 12px; padding: 0; font-size: 14px; font-weight: 650; }
    .insta-toolbox-settings-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 160px), 1fr)); align-items: start; gap: 12px 16px; }
    .insta-toolbox-settings-full { grid-column: 1 / -1; }
    .insta-toolbox-settings-dialog .insta-toolbox-field { min-width: 0; margin: 0; }
    .insta-toolbox-settings-dialog .insta-toolbox-disclosure { margin: 0; border: 0; border-top: 1px solid var(--insta-toolbox-line); border-radius: 0; background: transparent; }
    .insta-toolbox-settings-dialog .insta-toolbox-disclosure > summary { padding: 8px 0; }
    .insta-toolbox-settings-dialog .insta-toolbox-disclosure-body { padding: 0 0 4px; gap: 12px; }
    .insta-toolbox-settings-dialog .insta-toolbox-toolbar { justify-content: flex-start; gap: 8px; }
    .insta-toolbox-settings-check { display: flex; align-items: center; gap: 12px; min-height: 44px; font-size: 13px; line-height: 20px; }
    .insta-toolbox-settings-check input { flex: 0 0 auto; width: 18px; height: 18px; accent-color: var(--insta-toolbox-signal); }
    .insta-toolbox-settings-dialog [aria-describedby] + .insta-toolbox-note { margin-top: 4px; }
    .insta-toolbox-settings-data-danger { margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--insta-toolbox-line); }
  ...
  function create({ document: targetDocument, openShadow = false }) {
    ...
    shadow.innerHTML = `
            ...
            <div class="insta-toolbox-scroll">
              ...
              <section class="insta-toolbox-view" id="insta-toolbox-view-messages" role="tabpanel" aria-labelledby="insta-toolbox-tab-messages" tabindex="0" data-insta-toolbox-view="messages" hidden>
                ...
                <div class="insta-toolbox-primary-action" data-insta-toolbox-role="unsend-disclosure"><div class="insta-toolbox-gate-summary"><span><strong>DM Unsend</strong></span><span class="insta-toolbox-badge" data-insta-toolbox-role="unsend-badge">ready</span></div><div class="insta-toolbox-disclosure-body">
                  ...
                  <div class="insta-toolbox-field"><label for="insta-toolbox-unsend-speed">Speed</label><select class="insta-toolbox-select" id="insta-toolbox-unsend-speed" data-insta-toolbox-role="unsend-speed"><option value="standard">Standard</option><option value="fast">Fast</option></select></div>
      ...
      <dialog class="insta-toolbox-dialog insta-toolbox-settings-dialog" data-insta-toolbox-role="settings-dialog" aria-labelledby="insta-toolbox-settings-title" aria-describedby="insta-toolbox-settings-note">
        <template data-insta-toolbox-template="settings">
        <form>
          <div class="insta-toolbox-settings-heading"><h2 id="insta-toolbox-settings-title">Settings</h2><button class="insta-toolbox-icon-button" type="button" data-insta-toolbox-action="close-settings" aria-label="Close settings">${icons.svg('close')}</button></div>
          <p class="insta-toolbox-note" id="insta-toolbox-settings-note">Saved in this browser.</p>
          <fieldset class="insta-toolbox-settings-section"><legend>Appearance</legend><div class="insta-toolbox-settings-grid">
            ...
            <div class="insta-toolbox-field insta-toolbox-settings-full"><label for="insta-toolbox-pref-opacity">Opacity</label><div class="insta-toolbox-range-row"><input class="insta-toolbox-range" id="insta-toolbox-pref-opacity" type="range" min="55" max="100" step="1" value="88" data-insta-toolbox-preference="opacity"><output class="insta-toolbox-range-output" for="insta-toolbox-pref-opacity" data-insta-toolbox-role="opacity-output">88%</output></div></div>
            <div class="insta-toolbox-field"><label for="insta-toolbox-pref-blur">Blur</label><select class="insta-toolbox-select" id="insta-toolbox-pref-blur" data-insta-toolbox-preference="blur"><option value="none">Off</option><option value="soft">Soft</option><option value="strong">Strong</option></select></div>
            <div class="insta-toolbox-field"><label for="insta-toolbox-pref-launcher-size">Launcher size</label><select class="insta-toolbox-select" id="insta-toolbox-pref-launcher-size" data-insta-toolbox-preference="launcherSize"><option value="standard">Standard</option><option value="large">Large</option></select></div>
            <div class="insta-toolbox-toolbar insta-toolbox-settings-full"><button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" data-insta-toolbox-action="reset-layout">Reset layout</button></div>
          </div></fieldset>
          <details class="insta-toolbox-disclosure"><summary>More appearance options</summary><div class="insta-toolbox-disclosure-body">
            <div class="insta-toolbox-settings-grid">
            ...
            <div class="insta-toolbox-field"><label>Size presets</label><div class="insta-toolbox-toolbar"><button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" data-insta-toolbox-action="layout-preset" data-layout-preset="compact">Compact</button><button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" data-insta-toolbox-action="layout-preset" data-layout-preset="tall">Tall</button><button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" data-insta-toolbox-action="layout-preset" data-layout-preset="wide">Wide</button></div><p class="insta-toolbox-note" data-insta-toolbox-role="layout-size"></p></div>
            <p class="insta-toolbox-note">Drag the IT button or panel. Resize from either lower corner, or focus a handle and use arrow keys. Show or hide: Alt + Shift + I.</p>
            <button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" data-insta-toolbox-action="reset-appearance">Reset appearance</button>
          </div></details>
          <details class="insta-toolbox-disclosure" data-insta-toolbox-role="cleanup-settings"><summary>Cleanup defaults</summary><div class="insta-toolbox-disclosure-body">
            <div class="insta-toolbox-field"><label for="insta-toolbox-cleanup-speed">Speed</label><select class="insta-toolbox-select" id="insta-toolbox-cleanup-speed" data-insta-toolbox-cleanup-preference="speed" aria-describedby="insta-toolbox-fast-note"><option value="standard">Standard</option><option value="fast">Fast</option></select><p class="insta-toolbox-note" id="insta-toolbox-fast-note">Fast reduces menu waits. Target checks and pacing stay on.</p></div>
            <div class="insta-toolbox-settings-grid">
              <div class="insta-toolbox-field"><label for="insta-toolbox-default-scope">Message scope</label><select class="insta-toolbox-select" id="insta-toolbox-default-scope" data-insta-toolbox-cleanup-preference="messageScope"><option value="all">All sent messages</option><option value="newest">Newest N</option><option value="oldest">Oldest N</option></select></div>
              <div class="insta-toolbox-field" data-insta-toolbox-role="default-message-limit-field" hidden><label for="insta-toolbox-default-limit">Message count</label><input class="insta-toolbox-text-input" id="insta-toolbox-default-limit" type="number" min="1" max="250" value="1" data-insta-toolbox-cleanup-preference="messageLimit"></div>
            </div>
            <div><label class="insta-toolbox-settings-check"><input type="checkbox" disabled data-insta-toolbox-cleanup-preference="removeOwnReactions" aria-describedby="insta-toolbox-reactions-note">Remove my reactions afterward</label><p class="insta-toolbox-note" id="insta-toolbox-reactions-note">Unavailable until reaction ownership and removal can be verified.</p></div>
            <label class="insta-toolbox-settings-check"><input type="checkbox" checked data-insta-toolbox-cleanup-preference="showSummary">Show run summary</label>
          </div></details>
          <details class="insta-toolbox-disclosure" data-insta-toolbox-role="execution-settings"><summary>Execution</summary><div class="insta-toolbox-disclosure-body">
            <div class="insta-toolbox-field"><label for="insta-toolbox-execution">Run in</label><select class="insta-toolbox-select" id="insta-toolbox-execution" data-insta-toolbox-cleanup-preference="execution" aria-describedby="insta-toolbox-background-note"><option value="foreground">Foreground</option><option value="background" disabled>Background — unavailable</option></select><p class="insta-toolbox-note" id="insta-toolbox-background-note">Background recovery is not verified. Keep the conversation open.</p></div>
            <div class="insta-toolbox-field"><label for="insta-toolbox-workers">Managed tabs</label><input class="insta-toolbox-text-input" id="insta-toolbox-workers" type="number" min="1" max="1" value="1" disabled data-insta-toolbox-cleanup-preference="workerCount" aria-describedby="insta-toolbox-workers-note"><p class="insta-toolbox-note" id="insta-toolbox-workers-note">Managed inbox workers are not available yet.</p></div>
            <div class="insta-toolbox-field"><label for="insta-toolbox-scheduling">Scheduling</label><select class="insta-toolbox-select" id="insta-toolbox-scheduling" disabled data-insta-toolbox-cleanup-preference="scheduling"><option value="serial">One action at a time</option></select></div>
            <div><label class="insta-toolbox-settings-check"><input type="checkbox" disabled data-insta-toolbox-cleanup-preference="notifications" aria-describedby="insta-toolbox-notifications-note">Completion notifications</label><p class="insta-toolbox-note" id="insta-toolbox-notifications-note">Notifications are not supported by this build.</p></div>
          </div></details>
          <details class="insta-toolbox-disclosure" data-insta-toolbox-role="data-settings"><summary>Data and troubleshooting</summary><div class="insta-toolbox-disclosure-body">
            <p class="insta-toolbox-note" data-insta-toolbox-role="storage-usage">Storage usage unavailable.</p>
            <div class="insta-toolbox-toolbar"><a class="insta-toolbox-link-button" data-insta-toolbox-role="backup-local" aria-disabled="true">Export local data</a><a class="insta-toolbox-link-button" data-insta-toolbox-role="export-diagnostics" aria-disabled="true">Export diagnostics</a><button class="insta-toolbox-button insta-toolbox-button--quiet" type="button" disabled data-insta-toolbox-action="clear-history">Clear history</button></div>
            <p class="insta-toolbox-note">Version <span data-insta-toolbox-role="settings-version">unavailable</span></p>
            <div class="insta-toolbox-settings-data-danger"><button class="insta-toolbox-button insta-toolbox-button--danger" type="button" disabled data-insta-toolbox-action="delete-local-data">Delete local data</button></div>
            <p class="insta-toolbox-note">History and data deletion need a cross-tab idle check. For now, use Chrome's extension storage controls after closing Instagram tabs.</p>
          </div></details>
