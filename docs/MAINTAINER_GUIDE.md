...
4. Approve the protected `release` environment after reviewing the run and
   [acceptance record](./acceptance/4.1.6.md).
...
Version 4.1.6 publishes `insta-toolbox.user.js`,
`Insta-Toolbox-Extension-4.1.6.zip`, and `insta-toolbox-web-4.1.6.zip`. Do not
