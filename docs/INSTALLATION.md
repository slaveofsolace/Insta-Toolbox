# Install Insta Toolbox 4.1.6

The stable Tampermonkey link always installs the latest published release. Version 4.1.6 package names below become available after its release checks finish.
...
1. Download `Insta-Toolbox-Extension-4.1.6.zip` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
1. Download `Insta-Toolbox-Setup-4.1.6.exe` and `SHA256SUMS.txt` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
1. Download the recommended `Insta-Toolbox-4.1.6-universal.dmg` and `SHA256SUMS.txt` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
2. Verify the checksum.
...
The release also includes `Insta-Toolbox-4.1.6-universal.zip` as a portable alternative. Verify its checksum, extract it, and move **Insta Toolbox** to Applications. It contains the same universal app and has the same signing and notarization limits as the DMG.
...
1. Download `insta-toolbox-web-4.1.6.zip` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
```powershell
Get-FileHash .\Insta-Toolbox-Setup-4.1.6.exe -Algorithm SHA256
Get-FileHash .\Insta-Toolbox-Extension-4.1.6.zip -Algorithm SHA256
```

### macOS or Linux

```sh
shasum -a 256 Insta-Toolbox-4.1.6-universal.dmg
shasum -a 256 insta-toolbox-web-4.1.6.zip
```
...
- [4.1.6 acceptance record](acceptance/4.1.6.md)
- [4.1.6 compatibility](compatibility/4.1.6.md)
