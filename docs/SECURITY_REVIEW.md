...
The 3.0 account-free matrix contains 343 tests, 45 overlay states, and 11 PWA states. Final pass links and hashes belong in [the 3.0 acceptance record](./acceptance/3.0.0.md). Fixtures do not prove current authenticated Instagram behavior.
