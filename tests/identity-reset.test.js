...
test('all public surfaces share the 3.0.0 Insta Toolbox identity', () => {
...
test('Tampermonkey metadata uses the stable release channel', () => {
  ...
  assert.match(generatedUserscript, /@version\s+3\.0\.0/);
